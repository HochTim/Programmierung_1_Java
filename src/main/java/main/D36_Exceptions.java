...
public class D36_Exceptions {
	...
	/**
	 * Entry point – exercises several exception scenarios: out-of-bounds array
	 * access, a null dereference, repeated scanner input until a valid integer is
	 * entered, a safe downcast guarded by {@code instanceof}, and a custom checked
	 * exception thrown when a device is plugged in twice.
	 *
	...
	public static void main(String[] args) {
		...
		try {
			tableLight.plugIn();
			tableLight.plugIn();
		} catch (AlredyPluggedInException e) {
			System.out.println(e.getMessage());
		}
	}
